...
=================
*/
void Q_EXTERNAL_CALL S_StopAllSounds( void )
{
	if( si.StopAllSounds ) {
		si.StopAllSounds( );
	}
...
=================
*/
void Q_EXTERNAL_CALL S_SoundInfo( void )
{
	if( si.SoundInfo ) {
		si.SoundInfo( );
	}
...
=================
*/
void Q_EXTERNAL_CALL S_SoundList( void )
{
	if( si.SoundList ) {
		si.SoundList( );
	}
...
=================
*/
char * Q_EXTERNAL_CALL S_DumpGetSoundString( const char *pre, const char *post, const char *fmt )
{
	if( si.DumpGetSoundString ) {
		return si.DumpGetSoundString( pre, post, fmt );
	}
	return "";
}
