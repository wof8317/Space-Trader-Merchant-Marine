...
#define CHARACTERISTIC_AIM_ACCURACY_PISTOL		8	//float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_SHOTGUN			9	//float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_ROCKETLAUNCHER	10	//float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_GRENADE	11	//float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_HIGHCAL         12  //float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_ASSAULT		13	//float [0, 1]
...
#define CHARACTERISTIC_AIM_SKILL_GRENADE	18	//float [0, 1]
#define CHARACTERISTIC_AIM_SKILL_ASSAULT			19	//float [0, 1]
...
//how close a player has to be before the bot starts to spam
#define CHARACTERISTIC_CHAT_SPAM_DIST				49	//float [1, 4000]
//percent chance the bot will say something to you if he sees you.
#define CHARACTERISTIC_CHAT_SPAM_CHANCE             50  //float [0, 1]
