...
void BotTeamAI(bot_state_t *bs) {
	...
	// Drop out if it's GT_HUB Gametype
	if ( gametype < GT_TEAM || gametype == GT_HUB  )
		return;
...
==================
*/
void BotHubAI(bot_state_t *bs) {
    if (gametype != GT_HUB) return;
    //This should be changed to something like LTG_WAIT or something like that
