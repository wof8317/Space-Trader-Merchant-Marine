...
equ	ceil								-112
equ acos								-113
equ	testPrintInt						-114
equ	testPrintFloat						-115
...
equ trap_SQL_BindText			-604
equ trap_SQL_BindInt			-605
equ trap_SQL_Step				-606
equ trap_SQL_ColumnCount		-607
equ trap_SQL_ColumnAsText		-608
equ trap_SQL_ColumnAsInt		-609
equ trap_SQL_ColumnName			-610
equ trap_SQL_Done				-611
equ trap_SQL_Select				-612
equ trap_SQL_Reset				-613
