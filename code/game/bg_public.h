...
#define ANIM_TRANSITION_TIME 200

#define CHAT_DISTANCE 90.0f
...
#define CS_MUSICTRACK			27

#define CS_SPACETRADER			28
...
typedef enum {
	...
	GT_CAMPAIGN,		// single player campaign mode

	//-- team games go after this --

	GT_TEAM,			// team deathmatch
	GT_CTF,				// capture the flag
	GT_HUB,				// hub map gameplay
	GT_1FCTF,
	GT_ASSASSINATE,
	GT_HOSTAGE,
	GT_MOA,
...
#define PMF_BORED			64		// play custom idle anim
...
#define PMF_ANGRY			32768	// combat ready
...
typedef enum {
	...
	PERS_BONUS,						// Bonus money from completing an objective
	PERS_WIDTH,						// width modifier for the bounding box
} persEnum_t;
...
// animations
// when adding to this enum update the map in bg_misc.c
typedef enum {
	BOTH_EMPTY,
	BOTH_DEATH1,
	BOTH_DEAD1,
...
typedef enum {
    ...
    WEAPON_MELEE,
    WEAPON_QUICKRELOAD,
    WEAPON_QUICKRELOAD_FINISH,
    MAX_WEAPON_ANIMATIONS
} weapAnimNumber_t;

typedef struct animationMap_s {
	int animation;
	char *name;
} animationMap_t;
...
typedef struct gitem_s {
	...
	char		*radar_effect;	// name of the radar effect
} gitem_t;
...
//Locational Damage
//we are just using a basic bounding box, so we won't worry about being
//too accurate.
typedef enum {
    LOCATION_NONE,
    LOCATION_HEAD,
