...
//set hub goals
void BotHubSeekGoals(bot_state_t *bs);
//
...
//find a waypoint in the global array of waypoints
...
//If the bot can see a player, look at him, and maybe chat
int BotCanSeePlayer(bot_state_t *bs);
// if the bot can see another player
