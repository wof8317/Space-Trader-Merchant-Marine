...
void R_ToggleSmpFrame( void ) {
	...
	backEndData[tr.smpFrame]->commands.cmdsUsed = 0;
	backEndData[tr.smpFrame]->commands.dataUsed = 0;
...
=====================
*/
void Q_EXTERNAL_CALL RE_AddPolyToScene( qhandle_t hShader, int numVerts, const polyVert_t *verts, int numPolys ) {
	srfPoly_t	*poly;
	int			i, j;
	int			fogIndex;
	fog_t		*fog;
...
void Q_EXTERNAL_CALL RE_RenderScene( const refdef_t *fd )
{
	...
	tr.refdef.dofStrength = fd->dofStrength;
	tr.refdef.dofDepth = fd->dofDepth;
