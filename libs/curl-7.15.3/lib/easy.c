 ...
 */
CURLcode CURL_CALL curl_global_init(long flags)
{
  if (initialized++)
    return CURLE_OK;
 ...
 */
CURLcode CURL_CALL curl_global_init_mem(long flags, curl_malloc_callback m,
 ...
 */
void CURL_CALL curl_global_cleanup(void)
{
  if (!initialized)
    return;
 ...
 */
CURL* CURL_CALL curl_easy_init(void)
{
  CURLcode res;
 ...
 * previously setup.
 */
CURLcode CURL_CALL curl_easy_perform(CURL *curl)
{
 ...
 * easy handle.
 */
void CURL_CALL curl_easy_cleanup(CURL *curl)
{
  struct SessionHandle *data = (struct SessionHandle *)curl;
 ...
 */
CURL* CURL_CALL curl_easy_duphandle(CURL *incurl)
{
  bool fail = TRUE;
 ...
 */
void CURL_CALL curl_easy_reset(CURL *curl)
{
  struct SessionHandle *data = (struct SessionHandle *)curl;
